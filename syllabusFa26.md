...
Techno-utopian discourses often project a world in which machines do all the heavy lifting, bequeathing to us humans a post-scarcity, post-labor world. This course will take a different tack, to say the least, examining the relationship between digital interfaces and labor in its complexity and historicity and using a range of different methodologies. We will look at 
* *theorizations* of the way labor joins machines and bodies, from Marx’s *Grundrisse* to the work of Braverman in the 70s and Lazzarato in the 90s to more recent work on labor in the video game and AI industries
* *representations* of labor and technology in literature, film, television, and video games.
* *histories* that inform how recent emergences (such as AI) can be seen within longer historical trajectories of development, sometimes of astonishingly global reach and long duration

requirements: careful reading/watching and enthusiastic participation; several informal blog posts; an in-class presentation; and a final project (essay or digital project)
...
- learn from classic and contemporary theorizations of the "general intellect," "immaterial labor," and related concepts, from Marx to Pasquinelli
- examine the role "attention" plays in labor, as an extractive resource within what some call the new stage of "surveillance capitalism," and as a site of resistance and potential autonomy.
- explore the role of "playbor" in post-Fordist economy: the industry of games and gaming; the "gamification" of labor to boost productivity; and the way games/play might resist the above in some cases.
- examine "geographies" of AI: a look at cultural geographers' attempts to help us understand the "hyperobjects" that characterize digital economies and especially the AI buildup
- think about the implications of increasing reliance on digital tech for higher education in particular
- develop oral, research, and writing skills through informal responses, and in-class presentation, and a final project based on original research
...
## **Grading:** 
I will give detailed guidelines for the blog posts, collaborative project, presentation, and final project separately.  Your grade will be calculated as follows: blogging (25%); presentation (20%); final project (40%); participation (15%). 
